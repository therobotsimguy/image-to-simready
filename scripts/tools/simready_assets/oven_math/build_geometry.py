...
# Hardware spec (Gemini+Claude): bracket=20mm, pin=1.2mm, plate=3mm
lower_oven_door = kb.add_revolute_child(
    ...
    hinge_axis="X",
    hinges=[
        {"z": 0.0520, "side": "left", "door_inner_y": 0.2190, "body_inner_x": -0.2880, "plate_y": 0.2320, "bracket_width_mm": 20.0, "bracket_thickness_mm": 3.0, "pin_diameter_mm": 1.2},
        {"z": 0.0520, "side": "right", "door_inner_y": 0.2190, "body_inner_x": 0.2880, "plate_y": 0.2320, "bracket_width_mm": 20.0, "bracket_thickness_mm": 3.0, "pin_diameter_mm": 1.2},
    ]
)
...
upper_oven_door = kb.add_revolute_child(
    ...
    hinge_axis="X",
    hinges=[
        {"z": 0.4562, "side": "left", "door_inner_y": 0.2190, "body_inner_x": -0.2880, "plate_y": 0.2320, "bracket_width_mm": 20.0, "bracket_thickness_mm": 3.0, "pin_diameter_mm": 1.2},
        {"z": 0.4562, "side": "right", "door_inner_y": 0.2190, "body_inner_x": 0.2880, "plate_y": 0.2320, "bracket_width_mm": 20.0, "bracket_thickness_mm": 3.0, "pin_diameter_mm": 1.2},
    ]
)
...
# Knob: upper_oven_function_knob (cylinder, r=0.022m)
upper_oven_function_knob = kb.add_revolute_child(
    body, "upper_oven_function_knob",
    panels=[
        {"cx": -0.1875, "cy": 0.2527, "cz": 0.7480,
         "sx": 0.0435, "sy": 0.0174, "sz": 0.0435}
    ],
    hinge_pos=(-0.1875, 0.2440, 0.7480),
    hinge_axis="Y"
)
kb.apply_preset(upper_oven_function_knob, "chrome")

# Knob: upper_oven_temperature_knob (cylinder, r=0.021m)
upper_oven_temperature_knob = kb.add_revolute_child(
    body, "upper_oven_temperature_knob",
    panels=[
        {"cx": -0.0625, "cy": 0.2524, "cz": 0.7480,
         "sx": 0.0422, "sy": 0.0169, "sz": 0.0422}
    ],
    hinge_pos=(-0.0625, 0.2440, 0.7480),
    hinge_axis="Y"
)
kb.apply_preset(upper_oven_temperature_knob, "chrome")

# Knob: lower_oven_function_knob (cylinder, r=0.021m)
lower_oven_function_knob = kb.add_revolute_child(
    body, "lower_oven_function_knob",
    panels=[
        {"cx": 0.0625, "cy": 0.2524, "cz": 0.7480,
         "sx": 0.0422, "sy": 0.0169, "sz": 0.0422}
    ],
...
kb.apply_preset(lower_oven_function_knob, "chrome")

# Knob: lower_oven_temperature_knob (cylinder, r=0.021m)
lower_oven_temperature_knob = kb.add_revolute_child(
    body, "lower_oven_temperature_knob",
    panels=[
...
kb.apply_preset(lower_oven_temperature_knob, "chrome")
...
kb.export_blueprint("/home/msi/IsaacLab/scripts/tools/simready_assets/oven_math/raw_blueprint.usd")