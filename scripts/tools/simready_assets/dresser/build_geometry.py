...
# Body: 1.213 x 0.300 x 0.591m

body = kb.build_body("asset_body", panels=[
    {"cx": 0.0000, "cy": 0.0000, "cz": 0.0100, "sx": 1.2130, "sy": 0.3000, "sz": 0.0200},
    {"cx": 0.0000, "cy": 0.0000, "cz": 0.5809, "sx": 1.2130, "sy": 0.3000, "sz": 0.0200},
    {"cx": 0.0000, "cy": -0.1400, "cz": 0.2954, "sx": 1.2130, "sy": 0.0200, "sz": 0.5909},
    {"cx": -0.5965, "cy": 0.0000, "cz": 0.2954, "sx": 0.0200, "sy": 0.3000, "sz": 0.5909},
    {"cx": 0.5965, "cy": 0.0000, "cz": 0.2954, "sx": 0.0200, "sy": 0.3000, "sz": 0.5909}
])
...
kb.add_fixed_child(body, "divider_0", panels=[
    {"cx": 0.0000, "cy": 0.0000, "cz": 0.2003,
     "sx": 1.1730, "sy": 0.2600, "sz": 0.0200}
])

kb.add_fixed_child(body, "divider_1", panels=[
    {"cx": 0.0000, "cy": 0.0000, "cz": 0.3906,
     "sx": 1.1730, "sy": 0.2600, "sz": 0.0200}
])

kb.add_fixed_child(body, "divider_2", panels=[
    {"cx": 0.0000, "cy": 0.0000, "cz": 0.2954,
     "sx": 0.0200, "sy": 0.2600, "sz": 0.5509}
])
...
drawer_top_left = kb.add_prismatic_child(
    ...
    panels=[
        {"cx": -0.2983, "cy": 0.0200, "cz": 0.0320, "sx": 0.5725, "sy": 0.2400, "sz": 0.0200},
        {"cx": -0.5745, "cy": 0.0200, "cz": 0.1051, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.0220, "cy": 0.0200, "cz": 0.1051, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.2983, "cy": -0.0900, "cz": 0.1051, "sx": 0.5725, "sy": 0.0200, "sz": 0.1663},
        {"cx": -0.2983, "cy": 0.1400, "cz": 0.1051, "sx": 0.5765, "sy": 0.0300, "sz": 0.1703}
    ],
    slide_axis="Y"
)
...
# Drawer: drawer_bottom_left (row 1, col 0)
drawer_bottom_left = kb.add_prismatic_child(
    body, "drawer_bottom_left",
    panels=[
        {"cx": -0.2983, "cy": 0.0200, "cz": 0.2223, "sx": 0.5725, "sy": 0.2400, "sz": 0.0200},
        {"cx": -0.5745, "cy": 0.0200, "cz": 0.2954, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.0220, "cy": 0.0200, "cz": 0.2954, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.2983, "cy": -0.0900, "cz": 0.2954, "sx": 0.5725, "sy": 0.0200, "sz": 0.1663},
        {"cx": -0.2983, "cy": 0.1400, "cz": 0.2954, "sx": 0.5765, "sy": 0.0300, "sz": 0.1703}
    ],
    slide_axis="Y"
)
...
_h_drawer_bottom_left = kb.add_fixed_child(drawer_bottom_left, "handle_drawer_bottom_left", panels=[
    {"cx": -0.2983, "cy": 0.1600, "cz": 0.2954,
     "sx": 0.1200, "sy": 0.0200, "sz": 0.0200}
])
kb.apply_preset(_h_drawer_bottom_left, "brass")

# Drawer: drawer_top_right (row 1, col 1)
...
# Drawer: drawer_middle_right (row 2, col 0)
drawer_middle_right = kb.add_prismatic_child(
    body, "drawer_middle_right",
    panels=[
        {"cx": -0.2983, "cy": 0.0200, "cz": 0.4126, "sx": 0.5725, "sy": 0.2400, "sz": 0.0200},
        {"cx": -0.5745, "cy": 0.0200, "cz": 0.4857, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.0220, "cy": 0.0200, "cz": 0.4857, "sx": 0.0200, "sy": 0.2400, "sz": 0.1663},
        {"cx": -0.2983, "cy": -0.0900, "cz": 0.4857, "sx": 0.5725, "sy": 0.0200, "sz": 0.1663},
        {"cx": -0.2983, "cy": 0.1400, "cz": 0.4857, "sx": 0.5765, "sy": 0.0300, "sz": 0.1703}
    ],
    slide_axis="Y"
)
...
kb.export_blueprint("/home/msi/IsaacLab/scripts/tools/simready_assets/dresser/raw_blueprint.usd")