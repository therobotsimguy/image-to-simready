...
# Hardware spec (Gemini+Claude): bracket=35mm, pin=5.5mm, plate=5mm
lower_oven_door = kb.add_revolute_child(
    ...
    hinge_axis="X",
    hinges=[
        {"z": 0.0520, "side": "left", "door_inner_y": 0.2190, "body_inner_x": -0.2880, "plate_y": 0.2320, "bracket_width_mm": 35.0, "bracket_thickness_mm": 5.0, "pin_diameter_mm": 5.5},
        {"z": 0.0520, "side": "right", "door_inner_y": 0.2190, "body_inner_x": 0.2880, "plate_y": 0.2320, "bracket_width_mm": 35.0, "bracket_thickness_mm": 5.0, "pin_diameter_mm": 5.5},
    ]
)
...
# Hardware spec (Gemini+Claude): bracket=30mm, pin=4.4mm, plate=4mm
upper_oven_door = kb.add_revolute_child(
    ...
    hinge_axis="X",
    hinges=[
        {"z": 0.4562, "side": "left", "door_inner_y": 0.2190, "body_inner_x": -0.2880, "plate_y": 0.2320, "bracket_width_mm": 30.0, "bracket_thickness_mm": 4.5, "pin_diameter_mm": 4.4},
        {"z": 0.4562, "side": "right", "door_inner_y": 0.2190, "body_inner_x": 0.2880, "plate_y": 0.2320, "bracket_width_mm": 30.0, "bracket_thickness_mm": 4.5, "pin_diameter_mm": 4.4},
    ]
)
...
kb.export_blueprint("/home/msi/IsaacLab/scripts/tools/simready_assets/oven_physics/raw_blueprint.usd")